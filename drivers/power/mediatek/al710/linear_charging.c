...
static int g_jeita_first_set_cv=0;
...
PMU_STATUS do_jeita_state_machine(void)
{
    ...
    g_jeita_first_set_cv++;
	/* set CV after temperature changed */
	if (g_jeita_first_set_cv%12 ==1) {
        g_jeita_first_set_cv=1;
...
{
#if defined(MTK_CL_BCCT_SET_CURRENT_LIMIT)
    int current_limit = cl_bcct_cur_limit;
