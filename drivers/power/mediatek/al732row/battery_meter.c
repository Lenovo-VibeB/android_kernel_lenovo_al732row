...
void dod_init(void)
{
 ...
 #if 1
	//wangguan add 20150327
	ubvbat=get_Ubvbat();
	bm_print(BM_LOG_CRTI, "[FGADC] TEST ubvbat=%d\n", ubvbat);
	gFG_voltage=ubvbat+30;
	
	gFG_capacity_by_v = fgauge_read_capacity_by_v(gFG_voltage);
	bm_print(BM_LOG_CRTI, "[FGADC] TEST ubvbat=%d,gFG_voltage=%d,gFG_capacity_by_v =%d\n", ubvbat,gFG_voltage,gFG_capacity_by_v);
...
/* 5. Logging */
	printk(
		 "[FGADC] %d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d by likai\r\n",
