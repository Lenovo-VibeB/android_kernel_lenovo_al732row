...
//JC
  ...
  {0x40,1,{0x10}},    // AVDD=2.5 VCI,AVEE=-3VCI       14
	{0x41,1,{0x33}},    // AVDD=5.2 AVEE=-5.2 clamp      
	...
	{0x53,1,{0x40}},    // VGMN=-4.3V                   78  -4.5V//21
	//{0x57,1,{0x50}}, 
	{0x60,1,{0x07}},    // SDTI
	{0x61,1,{0x00}},    // CRTI
	{0x62,1,{0x08}},    // EQTI
	...
	{0xA3,1,{0x0f}},  // Gamma 16	/239 //2016/05/16 modify
	{0xA4,1,{0x09}},  // Gamma 24 /231
	{0xA5,1,{0x16}},  // Gamma 52 / 203
	{0xA6,1,{0x08}},  // Gamma 80 / 175 
	{0xA7,1,{0x07}},  // Gamma 108 /147
	{0xA8,1,{0x04}},  // Gamma 147 /108
	{0xA9,1,{0x09}},  // Gamma 175 / 80
	{0xAA,1,{0x07}},  // Gamma 203 / 52 
	{0xAB,1,{0x05}},  // Gamma 231 / 24
	{0xAC,1,{0x0b}},  // Gamma 239 / 16 
	{0xAD,1,{0x2c}},  // Gamma 247 / 8 
	{0xAE,1,{0x26}},  // Gamma 251 / 4 
...
#if defined(BUILD_LK)
			  printf("ili9806e_txd_hd720_dsi lk -- ili9806e 0x%x , 0x%x , 0x%x, 0x%x \n", id_high, id_midd, id_low, id);
#else
			  printk("ili9806e_txd_hd720_dsi kernel -- ili9806e 0x%x , 0x%x , 0x%x, 0x%x \n", id_high, id_midd, id_low, id);
#endif
...
// ---------------------------------------------------------------------------
LCM_DRIVER ili9806e_txd_hd720_dsi_vdo_fwvga_lcm_drv = {
	.name = "ili9806e_txd_hd720_dsi",
