...
static int s4AF_ReadReg(unsigned short *a_pu2Result)
{
	...
	*a_pu2Result = (read_data(0x02) << 8) + (read_data(0x03) & 0xff);
	...
	printk("[DW9718AF]  s4DW9718AF_ReadReg %d\n", *a_pu2Result);
	return 0;
}
#else
static int s4AF_ReadReg(unsigned short *a_pu2Result)
...
static int s4AF_WriteReg(u16 a_u2Data)
{
	int i4RetValue = 0;
#if 1//chenjun
    char puSendCmd[2] = {(char)(0x02) , (char)(a_u2Data >> 8)};
    char puSendCmd1[2] = {(char)(0x03) , (char)(a_u2Data & 0xFF)};
#else
