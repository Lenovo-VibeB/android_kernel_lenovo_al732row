...
static void set_mirror_flip(kal_uint8 image_mirror)
{
    ...
    switch (image_mirror) {
        case IMAGE_NORMAL://IMAGE_NOMAL:
            write_cmos_sensor(0x0000, 0x0300);//Set normal
            break;    
        case IMAGE_V_MIRROR://IMAGE_V_MIRROR:
            write_cmos_sensor(0x0000, 0x0100);	//Set flip
            break;
        case IMAGE_H_MIRROR://IMAGE_H_MIRROR:
            write_cmos_sensor(0x0000, 0x0200);//Set mirror
            break;
        case IMAGE_HV_MIRROR://IMAGE_H_MIRROR:
            write_cmos_sensor(0x0000, 0x0000);	//Set mirror & flip
            break;            
	default:
...
static void sensor_init(void)
{
	...
	printk("yinyapeng add hi553 init\n");
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
			...
			do {
				...
				if (*sensor_id == imgsensor_info.sensor_id) {	
					g_CurrUsedMainCameraName=MAIN_HI553;
					printk("yinyapeng add get hi553 id\n");
