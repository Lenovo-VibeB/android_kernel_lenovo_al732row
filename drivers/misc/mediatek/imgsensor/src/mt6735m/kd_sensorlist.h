...
UINT32 GC0310HQ_MIPI_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT * pfFunc);
UINT32 GC0310QH_MIPI_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT * pfFunc);
...
#endif
#if defined(OV8865_SUNNY_MIPI_RAW)
...
#endif
#if defined(GC0310_HQ_MIPI_YUV)
    {GC0310_HQ_SENSOR_ID, SENSOR_DRVNAME_GC0310_HQ_MIPI_YUV,GC0310HQ_MIPI_YUV_SensorInit},
#endif
#if defined(GC0310_QH_MIPI_YUV)
    {GC0310_QH_SENSOR_ID, SENSOR_DRVNAME_GC0310_QH_MIPI_YUV,GC0310QH_MIPI_YUV_SensorInit},
#endif
